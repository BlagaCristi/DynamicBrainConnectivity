...
class GraphMetricsGui:
    ...
    def __init__(self, tab_graph_metrics, top_module):

        # set tab
        self.tab_graph_metrics = tab_graph_metrics

        # set parent
        self.top_module = top_module

        self.tab_graph_metrics.bind("<Visibility>", self.on_visibility)
    ...
    def start_graph_metrics(self, data_path, output_path, trial_index, widget):
        ...
        # start graph metrics
        thread = threading.Thread(target = graph_metrics, args = (
            data_path,
            output_path,
            int(trial_index),
            False,
